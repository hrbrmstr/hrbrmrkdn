#' hrbrmstr's WPI Workshop R markdown format
#'
...
wpi <- function(number_sections = FALSE,
  ...
  dep <- htmltools::htmlDependency("skeleton", "2.0.4",
                                   system.file("rmarkdown", "templates", "wpi", "resources",
                                               package = "hrbrmrkdn"),
                                   stylesheet=c("normalize.css", "skeleton.css", "hrbrmstr.css"))
  ...
  args <- c(args, "--template",
            rmarkdown::pandoc_path_arg(system.file("rmarkdown", "templates", "wpi", "base.html",
                                                   package = "hrbrmrkdn")))
